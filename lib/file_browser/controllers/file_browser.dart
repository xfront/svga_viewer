...
enum Layout { LIST_VIEW, GRID_VIEW, TREE_VIEW }
...
class FileBrowserController extends GetxController {
  ...
  final currentDir = FileSystemEntry.blank().obs;
  final currentLayout = Layout.TREE_VIEW.obs;
  final showDirectoriesFirst = true.obs;
